...
class Parser (WaxeyeParser):
    ...
    automata = [FA("sentence", [State([Edge(1, 1, False)], False),
        ...
        FA("negation", [State([Edge(["N", "n"], 1, True)], False),
            ...
            State([], True)], FA.LEFT),
        FA("universal", [State([Edge(["A", "a"], 1, True)], False),
            State([Edge(["L", "l"], 2, True)], False),
            State([Edge(["L", "l"], 3, True)], False),
            State([Edge(13, 4, False)], False),
            State([Edge(11, 5, False)], False),
            State([Edge(13, 6, False)], False),
            State([Edge(1, 7, False)], False),
            State([], True)], FA.LEFT),
        FA("existential", [State([Edge(["S", "s"], 1, True)], False),
            State([Edge(["O", "o"], 2, True)], False),
            State([Edge(["M", "m"], 3, True)], False),
            State([Edge(["E", "e"], 4, True)], False),
            State([Edge(13, 5, False)], False),
            State([Edge(11, 6, False)], False),
            State([Edge(13, 7, False)], False),
            State([Edge(1, 8, False)], False),
            State([], True)], FA.LEFT),
        FA("binary", [State([Edge("(", 1, True)], False),
            State([Edge(1, 2, False)], False),
            State([Edge(13, 3, False)], False),
            State([Edge(12, 4, False)], False),
            State([Edge(13, 5, False)], False),
        ...
        FA("function", [State([Edge([(97, 122)], 1, False)], False),
            ...
            State([Edge("]", 4, True)], False),
            State([], True)], FA.LEFT),
        FA("termlist", [State([Edge(9, 1, False)], False),
            State([Edge(",", 2, True)], True),
            State([Edge(8, 3, False)], False),
            State([], True)], FA.LEFT),
        FA("term", [State([Edge(7, 1, False),
                Edge(11, 1, False),
        ...
        FA("wS", [State([Edge(" ", 1, False),
                Edge(13, 2, False)], False),
            State([], True),
            State([Edge(13, 2, False)], True)], FA.VOID)]
