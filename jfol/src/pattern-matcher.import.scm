...
(module pattern-matcher
    (expr-match?
     print-expression-evaluable
     ;;Boy, ya think maybe I should parameterize these thirteen billion functions...?
     apply-pattern-rule
     apply-pattern-rule-deep-while
     apply-pattern-rule-deep
     apply-pattern-rule-multi-result
     print-expression-evaluable
     expr-pattern-substitute
     apply-pattern-rules-condy-multi-result
     apply-pattern-rules-deep-while
     apply-pattern-rules-condy
     apply-pattern-rules-deep-while-sequence)
  (import chicken)
  (import scheme)
